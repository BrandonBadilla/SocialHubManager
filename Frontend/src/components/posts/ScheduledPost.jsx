...
const ScheduledPost = ({ onReset }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (scheduleTime < now) {
            alert('El horario seleccionado ya pasó. Por favor, selecciona otro.');
            return;
        }
    ...
    return (
        <div className="post-container">
            <h2 className="post-header">Programar Post</h2>
            <form onSubmit={handleSubmit} className="post-form">
                ...
                <div className="post-group">
                    <label htmlFor="schedule" className="post-label">Seleccionar Hora:</label>
                    <div className="post-select-wrapper">
                        <select
                        id="schedule"
